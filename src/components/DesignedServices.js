...
const DesignedServices = () => {
    return (_jsxs(Box, { className: 'boxServices', sx: { textAlign: 'center', padding: '40px 20px' }, children: [_jsxs("p", { className: 'titleServices', children: ["Nuestros  ", _jsx("p", { className: 'titlesGC', children: " Servicios Profesionales " }), " est\u00E1n dise\u00F1ados para: "] }), _jsx("div", { className: 'gridServices', children: services.map((service, index) => (_jsx("div", { children: _jsxs(Box, { sx: {
                            width: 170,
                            height: 170,
