                            ...
                            : true, sx: {
                                ...
                                "& .MuiTabs-scrollButtons": {
                                    "&.Mui-disabled": { opacity: 0.3 }, // Mejora la visibilidad de los botones
                                        ...
                                        }, className: 'image', src: image3, alt: "Service 1" })] }) }), _jsx(TabPanel, { value: value, index: 1, children: _jsxs("div", { className: 'corpSolutions', children: [_jsx("img", { style: {
                                            width: '50%',
                                            transition: "opacity 0.5s ease-in-out",
                                        }, className: 'image', src: image5, alt: "Service 1" }), _jsx("div", { className: 'text-corp', children: _jsx(BasicList, { items: legales }) })] }) }), _jsx(TabPanel, { value: value, index: 2, children: _jsxs("div", { className: 'corpSolutions', children: [_jsx("div", { className: 'text-corp', children: _jsx(BasicList, { items: contables }) }), _jsx("img", { style: {
                                            width: '50%',
                                            transition: "opacity 0.5s ease-in-out",
                                        }, className: 'image', src: contabilidadImg, alt: "Service 1" })] }) }), _jsx(TabPanel, { value: value, index: 3, children: _jsxs("div", { className: 'corpSolutions', children: [_jsx("img", { style: {
                                            width: '50%',
                                            transition: "opacity 0.5s ease-in-out",
                                        }, className: 'image', src: taxes, alt: "Service 1" }), _jsx("div", { className: 'text-corp', children: _jsx(BasicList, { items: fiscales }) })] }) }), _jsx(TabPanel, { value: value, index: 4, children: _jsxs("div", { className: 'corpSolutions', children: [_jsx("div", { className: 'text-corp', children: _jsx(BasicList, { items: consSocial }) }), _jsx("img", { style: {
                                            width: '50%',
                                            transition: "opacity 0.5s ease-in-out",
